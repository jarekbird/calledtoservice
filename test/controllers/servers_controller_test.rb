...
class ServersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create server" do
    assert_difference('Server.count') do
      post servers_url, params: { server: { member_id: @server.member_id, service: @server.service } }
    end
  ...
  test "should update server" do
    patch server_url(@server), params: { server: { member_id: @server.member_id, service: @server.service } }
